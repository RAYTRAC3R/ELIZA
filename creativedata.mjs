export const ElizaData = {
	...
	responses: {
		initial: [
			'Hi! Want to talk about your story?'
		],
		final: [
	...
	synonyms: {
		...
		'story': ['book', 'comic', 'game', 'series', 'cartoon', 'show']
	},
	preTransforms: [
		{ from: 'dont', to: 'don\'t' },
		{ from: 'cant', to: 'can\'t' },
			...
			rules: [
				{
					...
					responses: [
						...
						'Sometimes it\'s hard to put things into words. Can you describe your thoughts?',
			...
			rules: [
				{
					...
					responses: [
						...
						'What kinds of people or situations appeared in the dream?',
						'Do those dreams usually have recurring themes or symbols?',
						'Have your dreams been changing recently? In what way?',
						'What does that dream suggest to you?',
						'What person appeared in that dream?'
					]
				}
			]
		},
			...
			rules: [
				{
					...
					responses: [
						...
						'Hi there. What story would you\'d like to discuss?',
						'Hello. What brings you in to talk today?',
						'Greetings. How can I be of assistance to you in understanding your story?',
						'Welcome. What\'s on your mind that you\'d like to explore?',
						'Hi. Any problems with your story?'
					]
				}
			]
		},
